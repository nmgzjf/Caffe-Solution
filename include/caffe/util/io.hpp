...
#include "hdf5.h"
#include "D:/SoftwareDK/3rdparty/hdf5/hl/src/hdf5_hl.h"//Modified by Jianfeng
#include "caffe/test/mkstemp.h"//Modified by Jianfeng
...
inline void MakeTempDir(string* temp_dirname) {
  ...
  *temp_dirname = "/tmp/caffe_test.XXXXXX";
  ...
  //  char* mkdtemp_result = mkdtemp(temp_dirname_cstr);//Modified by Jianfeng
