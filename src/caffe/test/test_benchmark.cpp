//#include <unistd.h>  // for usleep//Modified by Jianfeng
...
#include <windows.h>//Modified by Jianfeng
...
TYPED_TEST(BenchmarkTest, TestTimerMilliSeconds) {
  ...
  EXPECT_FALSE(timer.has_run_at_least_once());
  timer.Start();
//  usleep(300 * 1000);//Modified by Jianfeng
  Sleep(300);//Modified by Jianfeng
