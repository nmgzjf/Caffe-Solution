...
#ifdef USE_CUDNN
//template <typename Dtype>//Modified by Jianfeng
template <typename TypeParam>
//class CuDNNLRNLayerTest : public GPUDeviceTest<Dtype> {//Modified by Jianfeng
class CuDNNLRNLayerTest : public GPUDeviceTest<TypeParam> {//Modified by Jianfeng
 protected:
  CuDNNLRNLayerTest()
      : epsilon_(Dtype(1e-5)),
        blob_bottom_(new Blob<Dtype>()),
...
//    const Blob<TypeParam>& blob_bottom, const LayerParameter& layer_param,//Modified by Jianfeng
//    Blob<TypeParam>* blob_top) {//Modified by Jianfeng
	const Blob<Dtype>& blob_bottom, const LayerParameter& layer_param,//Modified by Jianfeng
	Blob<Dtype>* blob_top) {//Modified by Jianfeng
